...
export function TelegramGate() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(4.5rem+env(safe-area-inset-bottom))] z-50 flex justify-center px-3">
      <div className="pointer-events-auto flex w-full max-w-md items-center gap-3 rounded-xl2 border border-ink-border bg-ink-surface/95 p-3 shadow-glass-lg backdrop-blur-xs animate-slide-up">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gold/90 shadow-glass">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-mint">
        ...
        <p className="flex-1 text-xs leading-snug text-white/80">
