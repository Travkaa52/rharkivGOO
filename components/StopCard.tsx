...
export function StopCard({ stop, etaMinutes, onClick }: { stop: Stop; etaMinutes?: number; onClick?: () => void }) {
  ...
  return (
    <div
      ...
      className="flex w-full cursor-pointer items-center gap-3 rounded-xl2 border border-ink-border bg-ink-surface/90 p-3 text-left shadow-glass transition hover:shadow-glass-lg active:scale-[0.99]"
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate font-body text-sm font-semibold text-white">{stop.name}</p>
