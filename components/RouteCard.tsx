...
export function RouteCard({ route }: { route: TransportRoute }) {
  ...
  return (
    <div
      ...
      className="flex cursor-pointer items-center gap-3 rounded-xl2 border border-ink-border bg-ink-surface/90 p-3 shadow-glass transition hover:shadow-glass-lg active:scale-[0.99]"
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate font-body text-sm font-semibold text-white">{route.name}</p>
