...
export function SearchBar({
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <div
        className={clsx(
          'flex items-center gap-3 rounded-xl2 border border-ink-border bg-ink-surface/80 px-4 py-3',
          'shadow-glass backdrop-blur-xs transition-shadow',
          focused && 'shadow-glass-lg ring-2 ring-gold/50'
        )}
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="shrink-0 text-white/50">
