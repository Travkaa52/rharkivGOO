...
const MIN_SPLASH_MS = 700; // достатньо, щоб анімація герба встигла дограти, і не мигтіла на швидких з'єднаннях
const MAX_SPLASH_MS = 4000; // запобіжник: якщо fonts.ready зависне (рідкісний edge case браузера) — не тримаємо користувача вічно
